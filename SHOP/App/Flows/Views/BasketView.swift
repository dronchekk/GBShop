...
final class BasketView: UIView {
    ...
    lazy var breadcrumbLabel: UILabel = {
        let label = UILabel()
        label.text = "Apple / Iphone / iPhone 14".uppercased()
    ...
    func demoData() {
        ...
        producnNameLabel.text = "iPhone 14"
        productDescriptionLabel.text = "iPhone 14 новая камера на 48 Мп, процессор A16 Bionic, 6 ГБ оперативной памяти и Touch ID в кнопке питания. "
